...
const isAdminOrStoreOrDoctor = (req, res, next) => {
...
module.exports = { verifyToken, isAdmin, isDoctor, isStore, isAdminOrDoctor, isStoreOrAdmin, isStoreOrDoctor, isAdminOrStoreOrDoctor };
